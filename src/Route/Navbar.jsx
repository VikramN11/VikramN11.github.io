...
const Navbar = () => {
  return (
    <div className={styles.navdiv} style={{display:"flex", justifyContent : "space-evenly", alignItems:"center", position:"sticky", top:"0px",boxShadow: "rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px", fontSize:"2.2rem", borderRadius:"0px 0px 5px 5px", padding:"10px", color:"#8892b0", backgroundColor:"#0a192f"}}>
